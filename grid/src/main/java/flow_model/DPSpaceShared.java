 ...
 * Data Production simulations.
 * Unfortunatelly, the SpaceShared is now set to public, thus can't be extended.
...
class DPSpaceShared extends AllocPolicy
{
     ...
     * @post $none
     */
    DPSpaceShared(String resourceName, String entityName) throws Exception
    {
