 ...
 * @invariant $none
 */
class NoNetworkSpaceShared extends AllocPolicy
{
     ...
     * @post $none
     */
    NoNetworkSpaceShared(String resourceName, String entityName) throws Exception
    {
    ...
    private void gridletFinish(ResGridlet rgl, int status)
    {
        ...
        //send gridlet with nop network delay
        Gridlet gl = rgl.getGridlet();
        sim_schedule(gl.getUserID(), GridSimTags.SCHEDULE_NOW, GridSimTags.GRIDLET_RETURN, gl);
